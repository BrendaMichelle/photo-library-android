...
public class PhotoListAdapter extends ArrayAdapter<Photo> {
    ...
    public PhotoListAdapter(@NonNull Context context, int resource, @NonNull List<Photo> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String fileName = Objects.requireNonNull(getItem(position)).getFileName();
        ...
        holder.photoCaption.setText(fileName);
